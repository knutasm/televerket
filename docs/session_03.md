...
Utangspunktet for design av makroer bør være det samme som for funksjoner i programmering for øvrig: den bør gjøre kun en ting, og ikke ha [sideeffekter](https://www.marktinderholt.com/software%20development/2024/12/10/avoid-side-effects.html)
